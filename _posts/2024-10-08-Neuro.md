...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture3.png" class="img-fluid rounded z-depth-1 w-70" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture4.png" class="img-fluid rounded z-depth-1 w-60" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture8.png" class="img-fluid rounded z-depth-1 w-60" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture10.png" class="img-fluid rounded z-depth-1 w-60" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture13.png" class="img-fluid rounded z-depth-1 w-70" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Neuron/Picture15.png" class="img-fluid rounded z-depth-1 w-70" %}
    </div>
</div>
